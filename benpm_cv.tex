...
{Fall 2023 - ...}{University of Utah}{\noindent
	Research with Dr. Cem Yuksel (\textit{cem@cemyuksel.com}) on building a more intuitive 3D modeling methodology
	\begin{itemize}
		\item Co-wrote a 3D modeling application in C++ and OpenGL
		\item Implemented a compact half-edge mesh representation, reducing 36 to 16 bytes per triangle
...
{June 2020 - July 2022}{Los Alamos National Laboratory}{\noindent
	\begin{itemize}
		...
		\item Published \href{https://asmedigitalcollection.asme.org/computingengineering/article-abstract/22/2/021009/1121736/simd-Optimized-Search-Over-Sorted-Data}{"SIMD-Optimized Search Over Sorted Data"} in ASME Computing and Engineering, in which I developed a SIMD-optimized logarithm-based search algorithm that improved over binary search by 100\% in vectorized contexts
	\end{itemize}
}
...
{Jan 2019 - June 2020}{New Mexico Institute of Mining and Technology}{\noindent
	\begin{itemize}
		\item Worked with Dr. Denis Cohen (\textit{denis.cohen@gmail.com}), and a fellow student to rewrite, parallelize, and optimize a complex 3D landslide simulation from scratch, while redesigning it to operate on unstructured meshes rather than a regular grid.
	\end{itemize}
}
