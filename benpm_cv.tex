...
\WorkEntry{Research Assistant}
	...
	\begin{itemize}
		\item Research assistant under Dr. Cem Yuksel working on polygon-free 3D modeling research in OpenGL
	\end{itemize}
}
...
\WorkEntry{Research Assistant}
	...
	\begin{itemize}
		\item Worked with Dr. Denis Cohen (denis.cohen@gmail.com) in developing a parallel, unstructured-mesh-based program for simulation of landslides using C++ and OpenMP
	\end{itemize}
}
